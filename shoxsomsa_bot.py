...
YANGI UPDATE (joriy):
  - 🍽 FILIAL-BO'YICHA ALOHIDA MENYU: endi Axsikent va Jasmin filiallarining
    menyulari BUTUNLAY ALOHIDA. Har bir filial o'z narxlari va taomlari bilan
    ishlaydi (masalan bir xil nomdagi taom ikkala filialda turli narxda bo'lishi mumkin).
  - 🛠 Admin panel → Menyu boshqaruvi endi AVVAL filialni so'raydi, keyin
    o'sha filialning kategoriyalarini ko'rsatadi.
  ...
  - 💾 PERSISTENCE: active_orders, order_counter va menyu endi /data/*.json fayllarga
...
SERVICE_FEE_PER_ITEM = 0       # endi alohida ko'rsatilmaydi — 1000 so'm taom narxining o'ziga qo'shildi
...
# ══════════════════════════════════════════
#  MENYU — FILIAL BO'YICHA ALOHIDA
#  RAW_MENU[filial_key][kategoriya][taom_nomi] = narx
#  (idish puli endi menyu keshi hisoblanganda qo'shiladi, RAW_MENU'da toza narx turadi)
# ══════════════════════════════════════════
DEFAULT_RAW_MENU_BY_BRANCH: dict[str, dict[str, dict[str, int]]] = {
    # ──────────────────────────────
    # JASMIN — eski menyu (o'zgarishsiz qoldi)
    # ──────────────────────────────
    "jasmin": {
        "🫕 Sho'rvalar": {
            "Mastava": 36_000,
            "Mol go'shtida sho'rva": 51_000,
            "Qo'y go'shtida sho'rva": 51_000,
            "Til sho'rva": 46_000,
            "Bo'yin sho'rva": 51_000,
            "Xash tuyoq sho'rva": 51_000,
            "Qozon kabob": 46_000,
            "Shoxona sho'rva": 71_000,
            "Manti sho'rva": 51_000,
            "Zakaz sho'rva": 71_000,
            "Manti": 9_000,
            "Kartoshka fri": 16_000,
            "Ko'za sho'rva": 41_000,
            "Osh Lazer": 36_000,
            "Quvvat sho'rva": 51_000,
        },
        "🥟 Somsalar": {
            "Qo'y go'shti turg'amchi": 11_000,
            "Mol go'shti turg'amchi": 11_000,
            "Sirli turg'amchi": 11_000,
            "Achchiq turg'amchi": 11_000,
            "Mayda turg'amchi": 9_000,
            "Mol go'shti tomchi": 11_000,
            "Tovuq go'shti somsa": 9_000,
            "Zakaz sirli": 11_000,
            "Ko'kli somsa": 6_000,
            "Kartoshkali somsa": 6_000,
            "Oshqovoqli somsa": 6_000,
            "Mador (So'qoq)": 8_000,
            "Tandir shashlik": 31_000,
            "Shoxona bir jilt": 21_000,
            "Sous": 4_000,
        },
        "🍣 Sushi rollar": {
            "Chuka salat": 26_000,
            "Filadelfiya (Klassik)": 86_000,
            "Filadelfiya (Avakado bilan)": 86_000,
            "Filadelfiya grill": 101_000,
            "Kaliforniya (Klassik)": 66_000,
            "Kaliforniya (Krabli)": 66_000,
            "Kaliforniya (Krevetka)": 81_000,
            "Kaliforniya (Ugor)": 86_000,
            "Kaliforniya (Tunets)": 71_000,
            "Запеченный с лососем": 66_000,
            "Запеченный с креветкой": 71_000,
            "Запеченный с курицей": 51_000,
            "Drakon roli": 121_000,
            "Сэт 1": 51_000,
            "Otjimaki roli": 71_000,
            "Бкин": 61_000,
            "Filadelfiya roli (Krevetka)": 96_000,
        },
        "🥗 Salatlar": {
            "Cho'ban salat": 31_000,
            "Сатэ": 46_000,
            "Класисcки": 21_000,
            "Choban salati": 36_000,
            "Свежий салат": 26_000,
            "Ташкентский салат": 21_000,
            "Vinegret": 31_000,
            "Греческий салат": 51_000,
            "Товукли салат": 37_000,
            "Chiroqchi": 36_000,
            "Акорошка": 21_000,
            "Сузма": 16_000,
            "Соллённый": 11_000,
            "Холодец": 21_000,
            "Цезарь": 41_000,
            "Хрустящий бакладжан": 46_000,
            "Каприз": 36_000,
            "Аливия": 36_000,
            "Шакароп": 16_000,
            "Свежий ассорти": 41_000,
            "Салат от ШЕФА": 81_000,
            "Японча": 51_000,
            "Баходиршох": 91_000,
            "American salat": 43_000,
            "Saboy qizilcha salat": 11_000,
            "Французский салат": 41_000,
            "Фантазия салат": 46_000,
            "Гнездо салат": 36_000,
            "Байский салат": 36_000,
            "Podshox salat": 51_000,
        },
        "🍖 Asosiy taomlar": {
            "Go'sht say": 76_000,
            "Sumburo": 91_000,
            "Uyg'urcha go'sht": 86_000,
            "Garnir": 21_000,
            "Adjika qayla": 6_000,
            "Ikra (qayla)": 6_000,
            "Smetana": 6_000,
            "Tovuq qanot": 36_000,
            "Uyg'urcha lagman": 41_000,
            "Premium Qozon kabob": 61_000,
            "Premium mastava": 36_000,
            "Чучвара гуштли": 31_000,
            "Сэт мясной 3п": 351_000,
            "Osh tuy oshi": 26_000,
            "Osh saboy": 21_000,
            "Zakaz osh": 41_000,
            "Do'lma": 36_000,
            "Ковурма лагмон": 41_000,
            "Sokoro": 91_000,
            "Tovuq": 41_000,
            "Mol go'shtida qotirma": 56_000,
            "Jiz 150 gr": 56_000,
            "Qo'zichoq till qaymoqli qayla bilan": 86_000,
        },
    },
    # ──────────────────────────────
    # AXSIKENT — yangi menyu
    # ──────────────────────────────
    "axsikent": {
        "🫕 Sho'rva / issiq taomlar": {
            "Mol sho'rva": 46_000,
            "Qo'y sho'rva": 51_000,
            "Tiftel sho'rva": 46_000,
            "Til sho'rva": 46_000,
            "G'alipsi sho'rva": 51_000,
            "Qozon kabob": 41_000,
            "Ko'za sho'rva": 51_000,
            "Banka sho'rva": 71_000,
            "Mastava": 31_000,
            "Dimlama banka": 66_000,
            "Mol qovurdoq 200gr": 61_000,
            "Qo'y qovurdoq 200gr": 66_000,
            "Qotirma mol": 51_000,
            "Qotirma qo'y": 61_000,
            "Chuchvar": 36_000,
            "Qotirma tovuq": 36_000,
            "Bishtekis": 26_000,
            "Bistirigin": 41_000,
            "Gulyash": 41_000,
            "Langet": 61_000,
        ...
        "🍜 Uyg'ur taomlari": {
            "Milliy lag'mon": 41_000,
            "Qovurma lag'mon": 41_000,
            "Retro lag'mon": 41_000,
            "Ayrim say": 51_000,
            "Go'sht say": 61_000,
            "Sokoro": 61_000,
            "Achiq go'sht 200gr": 71_000,
            "Sonboro": 61_000,
            "Qurtoba": 71_000,
            "Tuxum say": 31_000,
            "Tovuq say": 36_000,
            "Chuchvara say": 36_000,
        },
        "🥟 Somsalar": {
            "Qo'y go'shti": 16_000,
            "Mol go'shti katta": 16_000,
            "Sirlik katta": 11_000,
            "Achiq go'shlik": 11_000,
            "Qiyma go'sht": 11_000,
            "Tovuq go'sht": 9_000,
            "Mayda turg'amchi": 9_000,
            "Zakaz sirli": 11_000,
            ...
            "Ko'k": 6_000,
            "So'qoq": 6_000,
            "Qovurg'ali qo'y go'shti": 26_000,
            "Sous": 3_000,
            "Damashni duxopka somsa": 4_000,
        },
        "🥤 Ichimliklar": {
            "Damashni kanpot": 16_000,
            "Ayisti": 31_000,
            "Kola 1L": 14_000,
            "Kola 1.5L": 18_000,
            "Kola 0.5L": 11_000,
            ...
            "Banaqva 1L": 8_000,
            "Banaqva 0.5L": 6_000,
            "Fuyisti choy 1.5L": 18_000,
            "Fuyisti choy 1L": 14_000,
            "Fuyisti choy 0.5L": 11_000,
            "Kola banishni 0.5L": 16_000,
            "Kola banishni 0.25L": 11_000,
        },
        "🍲 Qo'shimchalar": {
            "Tarviz": 16_000,
            "Qovun": 16_000,
        ...
        "🍞 Non / Choy": {
            "Milliy ko'k choy": 6_000,
            "Ko'k choy 8810": 6_000,
            "Qora choy": 6_000,
            "Assorti non": 16_000,
            "Yog'siz non": 5_000,
            "Oq bolka": 6_000,
...
# ══════════════════════════════════════════
def load_menu() -> dict[str, dict[str, dict[str, int]]]:
    if MENU_FILE.exists():
        try:
            raw = json.loads(MENU_FILE.read_text(encoding="utf-8"))
            # Eski (filial-bo'yicha bo'lmagan) formatdan himoya — agar fayl eski
            # tekis formatda bo'lsa yoki filial kalitlari yo'q bo'lsa, standartga qaytamiz
            if raw and all(b in raw for b in BRANCHES):
                return raw
        except Exception as e:
            logging.warning(f"Menyu faylini o'qishda xato: {e} — standart menyu ishlatiladi")
    return {
        branch: {cat: dict(items) for cat, items in cats.items()}
        for branch, cats in DEFAULT_RAW_MENU_BY_BRANCH.items()
    }
...
RAW_MENU: dict[str, dict[str, dict[str, int]]] = load_menu()

# MENU[filial][kategoriya][nom] = menyuda ko'rinadigan narx (asl narx + mening haqqim)
# ALL_ITEMS[filial][nom] = savatga qo'shilgandagi/checkout uchun yakuniy narx (menyu narxi + idish puli)
MENU: dict[str, dict[str, dict[str, int]]] = {}
ALL_ITEMS: dict[str, dict[str, int]] = {}
...
def rebuild_menu_caches() -> None:
    ...
    MENU = {}
    ALL_ITEMS = {}
    for branch, cats in RAW_MENU.items():
        MENU[branch] = {
            cat: {name: price + SERVICE_FEE_PER_ITEM for name, price in items.items()}
            for cat, items in cats.items()
        }
        ALL_ITEMS[branch] = {}
        for _cat_items in MENU[branch].values():
            for _name, _menu_price in _cat_items.items():
                ALL_ITEMS[branch][_name] = _menu_price + DISH_FEE_PER_ITEM
...
#  (Rasm nomga bog'lanadi — ikkala filialda bir xil nomdagi taom bo'lsa rasm ham umumiy bo'ladi)
# ══════════════════════════════════════════
...
def cart_text(cart: dict, branch_key: str) -> str:
    if not cart:
        return "Savatcha bo'sh"
    lines, food_total = [], 0
    for name, qty in cart.items():
        menu_price = ALL_ITEMS[branch_key][name] - DISH_FEE_PER_ITEM  # idishsiz, menyuda ko'ringan narx
        sub = menu_price * qty
        food_total += sub
...
def cart_grand_total(cart: dict, branch_key: str) -> int:
    return sum(ALL_ITEMS[branch_key][n] * q for n, q in cart.items())
...
def categories_kb(branch_key: str) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text=cat, callback_data=f"cat:{cat}")]
        for cat in MENU[branch_key]
    ])

def items_kb(category: str, branch_key: str, cart: dict | None = None) -> InlineKeyboardMarkup:
    cart = cart or {}
    rows = []
    for name, menu_price in MENU[branch_key][category].items():
...
async def choose_branch(cb: CallbackQuery, state: FSMContext):
    ...
    if pending_action == "menu":
        ...
        await cb.message.answer("Kategoriyani tanlang 👇", reply_markup=categories_kb(key))
    else:
...
async def show_menu(msg: Message, state: FSMContext):
    ...
    if not data.get("branch_key"):
        ...
        return
    await state.set_state(OrderState.choosing_category)
    await msg.answer("Kategoriyani tanlang 👇", reply_markup=categories_kb(data["branch_key"]))
...
async def choose_category(cb: CallbackQuery, state: FSMContext):
    ...
    combined_kb = items_kb(cat, branch_key, cart)
    ...
    for name, menu_price in MENU[branch_key][cat].items():
...
async def back_categories(cb: CallbackQuery, state: FSMContext):
    ...
    await state.set_state(OrderState.choosing_category)
    try:
        await cb.message.edit_text("Kategoriyani tanlang 👇", reply_markup=categories_kb(data["branch_key"]))
    except Exception:
        try:
            await cb.message.delete()
        except Exception:
            pass
        await cb.message.answer("Kategoriyani tanlang 👇", reply_markup=categories_kb(data["branch_key"]))
    await cb.answer()
...
async def show_cart(msg: Message, state: FSMContext):
    ...
    cart = data.get("cart", {})
    await msg.answer(
        f"🛒 <b>Savatchangiz:</b>\n\n{cart_text(cart, data['branch_key'])}",
...
async def order_confirm(cb: CallbackQuery, state: FSMContext):
    ...
    branch_key = data["branch_key"]
    branch = BRANCHES[branch_key]
    items_total = cart_grand_total(cart, branch_key)
    oid    = next_order_id()
...
def admin_menu_branches_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text=b["title"], callback_data=f"ambranch:{key}")]
        for key, b in BRANCHES.items()
...
def admin_banner_categories_kb() -> InlineKeyboardMarkup:
    # Bannerlar barcha filiallardagi barcha kategoriyalar bo'yicha (kategoriya nomi umumiy)
    all_cats = []
    for cats in RAW_MENU.values():
    ...
    return InlineKeyboardMarkup(inline_keyboard=rows), all_cats
...
def admin_menu_categories_kb(branch_key: str) -> InlineKeyboardMarkup:
    rows = [
        [InlineKeyboardButton(text=cat, callback_data=f"amcat:{i}")]
        for i, cat in enumerate(RAW_MENU[branch_key].keys())
    ]
    rows.append([InlineKeyboardButton(text="➕ Yangi kategoriya", callback_data="amaddcat")])
    rows.append([InlineKeyboardButton(text="⬅️ Filial tanlashga", callback_data="adminpanel:menu")])
    return InlineKeyboardMarkup(inline_keyboard=rows)

def admin_items_kb(branch_key: str, cat_idx: int) -> InlineKeyboardMarkup:
    cat = list(RAW_MENU[branch_key].keys())[cat_idx]
    rows = []
    for j, (name, price) in enumerate(RAW_MENU[branch_key][cat].items()):
    ...
    rows.append([InlineKeyboardButton(text="⬅️ Orqaga", callback_data="amback")])
    return InlineKeyboardMarkup(inline_keyboard=rows)
...
async def admin_panel_menu(cb: CallbackQuery, state: FSMContext):
    if not is_admin(cb.from_user.id):
        await cb.answer("Ruxsat yo'q", show_alert=True)
        return
    await state.set_state(AdminMenuState.choosing_branch)
    await cb.message.edit_text("🍽 <b>Menyu boshqaruvi</b>\n\nQaysi filial menyusini tahrirlaymiz?", reply_markup=admin_menu_branches_kb())
    await cb.answer()

@dp.callback_query(F.data.startswith("ambranch:"))
async def admin_menu_choose_branch(cb: CallbackQuery, state: FSMContext):
    if not is_admin(cb.from_user.id):
        await cb.answer("Ruxsat yo'q", show_alert=True)
        return
    branch_key = cb.data.split(":", 1)[1]
    await state.update_data(am_branch=branch_key)
    await state.set_state(AdminMenuState.choosing_category)
    branch_title = BRANCHES[branch_key]["title"]
    await cb.message.edit_text(f"🍽 <b>{branch_title}</b>\n\nKategoriyani tanlang:", reply_markup=admin_menu_categories_kb(branch_key))
    await cb.answer()

@dp.callback_query(F.data == "amback")
async def admin_menu_back_to_categories(cb: CallbackQuery, state: FSMContext):
    if not is_admin(cb.from_user.id):
        await cb.answer("Ruxsat yo'q", show_alert=True)
        return
    data = await state.get_data()
    branch_key = data["am_branch"]
    await state.set_state(AdminMenuState.choosing_category)
    branch_title = BRANCHES[branch_key]["title"]
    await cb.message.edit_text(f"🍽 <b>{branch_title}</b>\n\nKategoriyani tanlang:", reply_markup=admin_menu_categories_kb(branch_key))
    await cb.answer()
...
async def admin_panel_banners(cb: CallbackQuery, state: FSMContext):
    if not is_admin(cb.from_user.id):
        ...
        return
    await state.clear()
    kb, all_cats = admin_banner_categories_kb()
    await state.update_data(banner_cats=all_cats)
    await cb.message.edit_text("🖼 <b>Kategoriya bannerlari</b>\n\nQaysi kategoriyaga banner qo'shamiz?", reply_markup=kb)
    await cb.answer()

@dp.callback_query(F.data.startswith("banncat:"))
async def admin_banner_show(cb: CallbackQuery, state: FSMContext):
    if not is_admin(cb.from_user.id):
        await cb.answer("Ruxsat yo'q", show_alert=True)
        return
    cat_idx = int(cb.data.split(":")[1])
    data = await state.get_data()
    all_cats = data.get("banner_cats", [])
...
async def admin_banner_clear(cb: CallbackQuery, state: FSMContext):
    if not is_admin(cb.from_user.id):
        await cb.answer("Ruxsat yo'q", show_alert=True)
        return
    cat_idx = int(cb.data.split(":")[1])
...
async def admin_menu_show_items(cb: CallbackQuery, state: FSMContext):
    ...
    await cb.message.edit_text(f"🍽 <b>{cat}</b>\n\nTaomni tanlang:", reply_markup=admin_items_kb(branch_key, cat_idx))
    await cb.answer()

@dp.callback_query(F.data.startswith("amitem:"))
async def admin_menu_item_detail(cb: CallbackQuery, state: FSMContext):
    if not is_admin(cb.from_user.id):
        await cb.answer("Ruxsat yo'q", show_alert=True)
        return
    ...
    branch_key = data["am_branch"]
    cat = list(RAW_MENU[branch_key].keys())[cat_idx]
    name = list(RAW_MENU[branch_key][cat].keys())[item_idx]
    price = RAW_MENU[branch_key][cat][name]
...
async def admin_menu_image_save(msg: Message, state: FSMContext):
    ...
    save_item_images()
    await state.set_state(AdminMenuState.choosing_item)
    await msg.answer(f"✅ <b>{name}</b> uchun rasm saqlandi.", reply_markup=admin_items_kb(branch_key, cat_idx))
...
async def admin_menu_image_delete(cb: CallbackQuery, state: FSMContext):
    if not is_admin(cb.from_user.id):
        await cb.answer("Ruxsat yo'q", show_alert=True)
        return
    _, cat_idx_s, item_idx_s = cb.data.split(":")
    ...
    await cb.message.edit_text(
        f"🍽 <b>{name}</b>\n💰 Narxi: {fmt(RAW_MENU[branch_key][cat][name])}\n🖼 Rasm: yo'q ❌\n\nNima qilamiz?",
...
async def admin_menu_edit_price_save(msg: Message, state: FSMContext):
    ...
    cat = list(RAW_MENU[branch_key].keys())[cat_idx]
    name = list(RAW_MENU[branch_key][cat].keys())[item_idx]
    RAW_MENU[branch_key][cat][name] = new_price
    rebuild_menu_caches()
    save_menu()
    await state.set_state(AdminMenuState.choosing_item)
    await msg.answer(f"✅ <b>{name}</b> narxi {fmt(new_price)} ga o'zgartirildi.", reply_markup=admin_items_kb(branch_key, cat_idx))

@dp.callback_query(F.data.startswith("amdel:"))
async def admin_menu_delete_item(cb: CallbackQuery, state: FSMContext):
    if not is_admin(cb.from_user.id):
        await cb.answer("Ruxsat yo'q", show_alert=True)
        return
    _, cat_idx_s, item_idx_s = cb.data.split(":")
    ...
    cat = list(RAW_MENU[branch_key].keys())[cat_idx]
    name = list(RAW_MENU[branch_key][cat].keys())[item_idx]
    del RAW_MENU[branch_key][cat][name]
    rebuild_menu_caches()
    save_menu()
    if name in ITEM_IMAGES:
...
async def admin_menu_add_item_price(msg: Message, state: FSMContext):
    ...
    cat = list(RAW_MENU[branch_key].keys())[cat_idx]
    RAW_MENU[branch_key][cat][name] = price
    rebuild_menu_caches()
    save_menu()
    await state.set_state(AdminMenuState.choosing_item)
    await msg.answer(f"✅ <b>{name}</b> — {fmt(price)} menyuga qo'shildi.", reply_markup=admin_items_kb(branch_key, cat_idx))
...
async def admin_menu_add_category_save(msg: Message, state: FSMContext):
    ...
    data = await state.get_data()
    branch_key = data["am_branch"]
    if name in RAW_MENU[branch_key]:
        await msg.answer("⚠️ Bu kategoriya allaqachon mavjud.")
        return
    RAW_MENU[branch_key][name] = {}
    rebuild_menu_caches()
    save_menu()
    await state.set_state(AdminMenuState.choosing_category)
    await msg.answer(f"✅ <b>{name}</b> kategoriyasi qo'shildi.", reply_markup=admin_menu_categories_kb(branch_key))
...
async def main():
    ...
    for _b in BRANCHES:
        logging.info(f"  {_b}: {len(ALL_ITEMS.get(_b, {}))} taom")
